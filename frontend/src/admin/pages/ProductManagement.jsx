// admin/pages/ProductsManagement.jsx
...
const ProductsManagement = () => {
  ...
  const handleCreateOrUpdate = async () => {
    try {
      ...
      if (product.file) {
        formData.append("file", product.file); // Only append if there is a file
      }

      if (isEditing) {
        await axios.put(`${import.meta.env.VITE_API_URL}/inventory/${product._id}`, formData, {
